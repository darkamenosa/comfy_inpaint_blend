...
class EnhancedImageCompositeMasked:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "blend_mode": (["default", "poisson"], {"default": "poisson"}),
            },
            "optional": {
                "mask": ("MASK",),
            }
    ...
    def composite(self, destination, source, x, y, resize_source, blend_mode="poisson", mask=None):
